...
public class InstructorMessages
{
    ...
    public static string InstructorIdCheck = "Instructor ID could not be found";
    public static string EmailCheck = "Email is already exist";
    public static string NationalIdentityCheck = "NationalIdentity is already exist";
}
